    ...
    <View>
      ...
      <View style={styles.bottom} >
        <View style={{ alignItems: 'center' }}>
          <Image style={styles.imghome} source={{ uri: 'https://images.unsplash.com/photo-1522096675830-2d2ce3a8c389?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=600&ixid=MnwxfDB8MXxyYW5kb218MHx8Y29mZmVlLGNvZmZlZXx8fHx8fDE3MTIxMzk5MDc&ixlib=rb-4.0.3&q=80&w=720' }} />
        </View>
...
const Home = () => {
  return (
    ...
    >
      <Tab.Screen name="HomeScreen" options={{ headerShown: false }} component={HomeSceen} />
